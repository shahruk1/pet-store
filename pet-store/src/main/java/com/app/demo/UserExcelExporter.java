...
public class UserExcelExporter {
    ...
    private void writeHeaderLine() {
        ...
        createCell(row, 6, "PetName", style);
        createCell(row, 7, "StoreName", style);
        createCell(row, 8, "FoodName", style);
        createCell(row, 9, "Booked on", style);
//        createCell(row, 10, "Event Date", style);
//        createCell(row, 11, "Number of guest", style);
        createCell(row, 10, "Appointment_time", style);
//        createCell(row, 13, "Event Start time", style);
        createCell(row, 11, "Store Fees", style);
        createCell(row, 12, "Food Price", style);
        createCell(row, 13, "Total Price", style);
        createCell(row, 14, "Accept Status", style);
        createCell(row, 15, "Payment Status", style);
