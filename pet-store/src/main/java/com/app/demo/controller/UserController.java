...
//			System.out.println(bookings);
	...
	@RequestMapping(path="/userbookingcancel/{id}",method=RequestMethod.GET)
	public String userbookingcancel(@PathVariable("id") int id) {
		System.out.println("yes booking cancel function called");
...
//		System.out.println(booking);
		...
		public void sendEmail(String recipientEmail, String link)
		    ...
		    helper.setFrom("shahruk2245@gmail.com", "Cats&Dogs");
