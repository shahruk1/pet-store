    ...
    <div id="content">
         ...
         <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    ...
                    <div>
                    	<h3 class="text-info">PET DETAILS</h3>
                    </div>
                   <div>
...
<nav class="d-flex justify-content-between">
     ...
     <form class="d-flex">
        <button type="button" class="btn btn-info ml-2" name="add_event" data-toggle="modal" data-target="#AddeventModal" data-whatever="@mdo">Add Pet</button>
    </form>
            ...
            <form action="/addeventForm" modelAttribute="eventForm"  method="POST" enctype= "multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="message-text" class="col-form-label">Pet Name:</label>
                        <input type="text" class="form-control" placeholder="" name="eventname" id="eventname" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="message-text" class="col-form-label">Pet Description</label>
						<textarea class="form-control" name="event_desc" placeholder="Description" id="event_desc"></textarea>
                    </div>
                    
                    <div class="form-group">
                        <label for="message-text" class="col-form-label">Pet price:</label>
                        <input type="text" class="form-control" placeholder="price" name="event_price" id="event_price" required>
                    </div>
                    <div class="form-group">
                        <label for="message-text" class="col-form-label">Pet Image:</label>
                        <input type="file" class="form-control" name="event_img" id="event_img" required>
                    
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-info" name="addevent" >Add pet</button>
                </div>
            </form>
            </div>
        </div>
                	 ...
                	 <c:forEach var="allevent" items="${eventlist}" >
			           ...
			           <td ><img src="data:image/jpeg;base64,${allevent.event_img}" class="rounded-circle" width="100" height="100"/></td>
                        <td class="d-flex">
                            ...
                            <a href="/admindeleteevent/${allevent.id}" class="btn btn-danger ml-2" onclick='returndeleteEvent();'>DELETE</a>
                        </td>
                        </tr>
                    </c:forEach>
                </tbody>
			 ...
			 <div class="modal fade" id="EditeventModal" tabindex="-1" role="dialog" aria-labelledby="AdduserModalLabel" aria-hidden="true">
				<div class="modal-dialog" role="document">
					...
					<form action="/EditeventForm" modelAttribute="eventEditForm" method="POST" enctype= "multipart/form-data">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
							<button type="submit" class="btn btn-info" name="Editevent" >Edit Pet info</button>
						</div>
					</form>
					</div>
				</div>
