	...
	<section class="mt-5 ">
		...
		<div class="container ">
		    <div class="row align-items-center justify-content-center my-5">
		        ...
		        <!-- Registeration Form -->
		        <div class="col-lg-5 col-md-4 col-sm-4 mt-5">
		        ...
		        <div class="text-center social-btn">
		            <a href="#" class="btn btn-black"><i class="fab fa-facebook"></i>&nbsp;</a>
		            <a href="#" class="btn btn-blue"><i class="fab fa-twitter"></i>&nbsp;</a>
					<a href="#" class="btn btn-black"><i class="fab fa-google"></i>&nbsp;</a>
		        </div>
		    </form>
