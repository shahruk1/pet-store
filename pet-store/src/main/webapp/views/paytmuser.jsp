...
<nav class="navbar navbar-expand-md navbar-dark  bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="/userbookingdetails">Home</a>
				                ...
				                <div class="row">
                                    ...
                                    <div class="col-lg-5 col-md-5 col-sm-12 mb-2 ml-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="INDUSTRY_TYPE_ID" value="Retail" name="INDUSTRY_TYPE_ID" readonly/>
                                        </div>
                                    </div>
                                    <div class="col-lg-5 col-md-5 col-sm-12 mb-2 ml-3">
                                        <div class="form-group">
